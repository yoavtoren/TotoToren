...
const TIEBREAKERS = [
  'נקודות במשחקים בין הנבחרות הקשורות (גול-גול)',
  'הפרש שערים במשחקים בין הנבחרות הקשורות',
  'שערים שבוקעו במשחקים בין הנבחרות הקשורות',
  '(חוזרים על 1–3 אם עדיין יש שוויון בתת-נבחרת)',
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <GlassCard className="space-y-3">
        ...
        <p className="text-sm text-white/70 leading-relaxed">
          לראשונה, המונדיאל כולל <strong className="text-white">48 נבחרות</strong> ב-
          <strong className="text-white">12 בתים</strong> (A–L), 4 נבחרות לבית. כל נבחרת משחקת נגד שלוש
      ...
      <GlassCard className="space-y-3">
        ...
        <p className="text-sm text-white/70 leading-relaxed">
          ...
          תיקו = <strong className="text-white">נקודה</strong>, הפסד = 0. שתי הנבחרות הראשונות בכל בית
          עוברות אוטומטית (24 נבחרות). 8 הנבחרות הטובות שסיימו שלישיות גם עוברות — סך הכל 32 בשלב הנוקאאוט.
        </p>
        <div>
      ...
      {/* שלישיות */}
      <GlassCard className="space-y-3">
        <h2 className="text-lg font-bold">8 הנבחרות הטובות במקום השלישי</h2>
        <p className="text-sm text-white/70 leading-relaxed">
          כל 12 הנבחרות שסיימו שלישיות מדורגות לפי הקריטריונים הבאים. 8 הטובות מהן עוברות לשלב 32.
      ...
      <GlassCard className="space-y-3">
        ...
        <p className="text-xs text-white/30 pt-2">
          ...
          1X2 נכון + שערים נכון (אבל לא מדויק) = 3 נקודות. דירוגי ההתקדמות עצמאיים — נבחרת שנוחשה נכון מנקדת בכל שלב שהיא מגיעה אליו.
        </p>
      </GlassCard>
