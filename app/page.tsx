...
const FEATURES = [
  { icon: '🗂️', title: 'דרגו את כל 12 הבתים',   body: 'גררו את 4 הנבחרות בכל בית לפי הסדר שאתם מנחשים. מי יהיה ראשון, מי שני, ומי ייפול.' },
  { icon: '🏆', title: 'בנו את הסבב שלכם',        body: 'שלב 32 מתמלא אוטומטית מהבתים. בחרו את 8 הנבחרות שלדעתכם יעברו במקום השלישי, ואחר כך נחשו כל משחק נוקאאוט עד הגמר.' },
  { icon: '📊', title: 'טבלת ניקוד בזמן אמת',    body: 'ראו איפה אתם עומדים לעומת החברים ככל שהתוצאות מתפרסמות. תוצאות מדויקות, 1X2 נכון, התקדמות של נבחרות — כל נקודה קובעת.' },
        ...
        <GlassCard className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            {[
              ...
              ['ניחוש נבחרת בטופ-2',              '+1 נק׳'],
              ['נבחרת עוברת שלב 32 ← 16',         '+4 נק׳'],
              ['נבחרת עוברת שלב 16 ← רבע',        '+5 נק׳'],
              ['נבחרת עוברת רבע ← חצי',           '+6 נק׳'],
              ['נבחרת עוברת חצי ← גמר',           '+7 נק׳'],
